...
router.put('/pessoas/:id/restaura', (req, res) => pessoaController.restaura(req, res));
...
router.put('/pessoas/:estudanteId/matriculas/:id', (req, res) => matriculaController.atualiza(req, res));
